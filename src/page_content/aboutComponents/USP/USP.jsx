    ...
    <div>
      ...
      <section className="vision-section">
        <div className="vision-cards">
          <div className="common-card" style={{maxWidth:"400px"}}>
          ...
          <div className="common-card" style={{maxWidth:"400px"}}>
            <p className="innerpage-hg">
              Extensive Professional Infrastructure
            </p>
            <p>
              MITSFT offers over thirty units of professional cameras, editing
              systems, and sound recording equipment, allowing students to work
              on a one to one basis. The School also houses a dedicated shooting
